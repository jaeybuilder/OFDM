...
public class IFFT {
	...
	public IFFT(ArrayList<Double[][]> s) {
		...
		//	System.out.print("Transformada inversa: \n");
		//	for (int i = 0; i < this.N; i++)
		...
		for (int j = 0; j < s.size(); j++) {
			...
			for (int i = 0; i < this.N; i++) {
				a[i][0] = this.result.get(j)[i][0]/this.N;
				a[i][1] = this.result.get(j)[i][1]/this.N;
			}
			for (int i = 0; i < this.N; i++) {
		...
		//for (int j = 0; j < s.size(); j++) {
		//	System.out.print("Transformada inversa bitreversal: \n");
		//	for (int i = 0; i < this.N; i++)
		//		System.out.println(this.result.get(j)[i][0] + " i, " + this.result.get(j)[i][1] + "j");
		//}
	}
